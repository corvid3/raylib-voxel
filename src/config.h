...
// define the maximum number of render textures allowed to recurse
// before halting (halting recursive rendering this way is not intended)
#define MAX_REND_TEXTS 32
...
#define RL_CULL_DISTANCE_FAR                                                   \
  5000.0 // Default projection matrix far cull distance
...
#define RL_DEFAULT_SHADER_ATTRIB_NAME_TEXW                                     \
  "vertexTexW" // Bound by default to shader location: 6
...
#define RL_DEFAULT_SHADER_SAMPLERARRAY2D_NAME_TEXARRAY0                        \
  "textureArray0" // texture array 0

...
Vector3RotateByAxisAngle(Vector3 v, Vector3 axis, float angle)
{
  ...
  Vector3 wv = { w.y * v.z - w.z * v.y,
                 w.z * v.x - w.x * v.z,
                 w.x * v.y - w.y * v.x };

  // Vector3CrossProduct(w, wv)
  Vector3 wwv = { w.y * wv.z - w.z * wv.y,
                  w.z * wv.x - w.x * wv.z,
                  w.x * wv.y - w.y * wv.x };
...
MatrixLookAt(Vector3 eye, Vector3 target, Vector3 up)
{
  ...
  Vector3 vx = { up.y * vz.z - up.z * vz.y,
                 up.z * vz.x - up.x * vz.z,
                 up.x * vz.y - up.y * vz.x };
  ...
  Vector3 vy = { vz.y * vx.z - vz.z * vx.y,
                 vz.z * vx.x - vz.x * vx.z,
                 vz.x * vx.y - vz.y * vx.x };
  ...
  result.m11 = 0.0f;
  result.m12 =
    -(vx.x * eye.x + vx.y * eye.y + vx.z * eye.z); // Vector3DotProduct(vx, eye)
  result.m13 =
    -(vy.x * eye.x + vy.y * eye.y + vy.z * eye.z); // Vector3DotProduct(vy, eye)
  result.m14 =
    -(vz.x * eye.x + vz.y * eye.y + vz.z * eye.z); // Vector3DotProduct(vz, eye)
  result.m15 = 1.0f;
